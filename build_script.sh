...
git clone https://github.com/stephensalim/oncall-health-app.git
cd ~/environment/oncall-health-sample-app/oncall-health-app
mkdir ~/environment/oncall-health-sample-app/oncall-health 
cd ~/environment/oncall-health-sample-app/oncall-health
git init
git pull ~/environment/oncall-health-sample-app/oncall-health-app master
git remote add origin codecommit://oncall-health
git push -u origin master
rm -rf ~/environment/oncall-health-sample-app/oncall-health-app
echo "# Clone Application >> Complete"
